...
import type { Expense, Participant, Transfer } from "@/lib/acerta/types";
import { allocateExpense, expenseIsBalanced, splitTotal } from "@/lib/acerta/engine";
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span aria-hidden="true" className="grid size-10 place-items-center rounded-2xl bg-muted text-xl">
          {expense.emoji}
        </span>
