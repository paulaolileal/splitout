  ...
  head: () => ({
    meta: [
      ...
      { title: "Acerta — Divida o rolê. Acerte as contas." },
      {
        name: "description",
        content:
          "Divida despesas de rolês, viagens e restaurantes. O Acerta calcula quem deve quanto para quem.",
      },
      { name: "theme-color", content: "#faf8f2" },
      { name: "apple-mobile-web-app-title", content: "Acerta" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { property: "og:title", content: "Acerta — Divida o rolê. Acerte as contas." },
      {
        property: "og:description",
        content: "O Acerta calcula quem deve quanto para quem, sem planilha e sem discussão.",
      },
